 ...
 *
 */
public abstract class BaseGameFragment extends Fragment implements IGameInterface, IRendererListener   {
	...
	private void callGameResumedOnUIThread() {
		BaseGameFragment.this.getActivity().runOnUiThread(new Runnable() {
			@Override
			public void run() {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		return this.mRenderSurfaceView;//, BaseGameFragment.createSurfaceViewLayoutParams());
	}
...
//		this.mRenderSurfaceView.setRenderer(this.mEngine, this);
//
//		this.setContentView(this.mRenderSurfaceView, BaseGameFragment.createSurfaceViewLayoutParams());
//	}
